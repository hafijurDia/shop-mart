              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-sm">
                  ...
                  <tr>
                    ...
                    <td>
                    	<a href="{{$row->id}}" class="btn btn-info btn-sm edit" data-id="{{$row->id}}" data-toggle="modal" data-target="#editModel"><i class="fas fa-edit"></i></a>
	      ...
	      <div class="modal-body">
	       <div class="mb-3">
			...
			<div class="mb-3">
			  ...
			  <input type="text" class="form-control" name="subcategory_name" placeholder="Category name" required="1">
